...
export const CAPABILITIES: Capability[] = [
  // ⚠️ 这里**用供应商真名**，别再"改成能力话术"。2026-09-03 我改过一次「搜索服务」，当天撤回：
  //   禁词表原文是「Joe 视线区三页适用，**机器房豁免**」，而这张表就活在机器房；
  //   且 Joe 定这张表时的原话是「我好知道哪个环节使用了什么工具」—— 供应商真名对他是
  //   **可操作信息**（照着去查账单/额度），换成"搜索服务"他反而不知道该开哪个后台。
  //   ⇒ Serper / Resend / deepseek-* / 飞书 / Hunter 一律真名。
